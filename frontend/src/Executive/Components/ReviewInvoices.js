...
import ExereviewServices from '../Services/ExereviewServices'

const ReviewInvoices = ({ data }) => {
    const navigate = useNavigate()
    const { shopkeeper, getShopkeeper, getCustomer, customer, FutureDate, downloadInvoice } = ExereviewServices({ data })
    useEffect(() => {
        const getdata = async () => {
