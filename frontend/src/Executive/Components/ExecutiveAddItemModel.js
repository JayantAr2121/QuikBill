...
import ExeAddItemService from '../Services/ExeAddItemService'

const ExecutiveAddItemModel = (props) => {

    const { search, searched, getallitems, setsearch } = ExeAddItemService(props)
...
export default ExecutiveAddItemModel