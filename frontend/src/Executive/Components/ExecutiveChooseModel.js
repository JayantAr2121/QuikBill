...
import ExeChooseCustomerService from '../Services/ExeChooseCustomerService'

const ExecutiveChooseModel = (props) => {
    const navigate = useNavigate()
    const { getallitems, setsearch, search, searched } = ExeChooseCustomerService(props)
    useEffect(() => {
        const getdata = async () => {
...
export default ExecutiveChooseModel