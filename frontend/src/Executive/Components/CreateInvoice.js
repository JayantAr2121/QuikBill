...
import ExecutiveChooseModel from '../Components/ExecutiveChooseModel'
import ExecutiveAddItemModel from '../Components/ExecutiveAddItemModel'
import { useNavigate } from 'react-router-dom'
import Api from '../../Api/InstanceApi'
import ExeCreateInvoice from '../Services/ExeCreateInvoice'
const CreateInvoice = ({ setinvoices }) => {
    ...
    const { submit, remove, changediscount, removequantity, addquantity, loading, result, customer, items, setcustomer, setitems } = ExeCreateInvoice({ setinvoices })
    ...
    return (
        <div className="main-content">
                                ...
                                <form onSubmit={submit} className="needs-validation" noValidate id="invoice_form">
                                    ...
                                    <div className="card-body p-4">
                                        ...
                                        <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                                            ...
                                            <a onClick={() => navigate("/Executive")} className="btn btn-danger"><i className="ri-send-plane-fill align-bottom me-1" />Discard</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            {ChooseCustomerToggle && <ExecutiveChooseModel setcustomer={setcustomer} setToggle={setChooseCustomerToggle} />}
            {AddItemModalToggle && <ExecutiveAddItemModel items={items} setitems={setitems} setToggle={setAddItemModalToggle} />}
            <Footer />
        </div>
    )
}
