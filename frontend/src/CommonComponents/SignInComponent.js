...
const SignInComponent = () => {
   ...
   const { submit, set,loading,rememberme,setrememberme} =LoginServices()
    return (
                                    ...
                                    <div className="card my-auto ">
                                        <div className="col-lg-12">
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="mt-4">
                                                    <form onSubmit={submit} className="auth-input">
                                                        <div className="mb-3">
                                                            <label htmlFor="email" className="form-label">Email</label>
                                                            <input onChange={set} type="email" name='email' className="form-control" id="email" placeholder="Enter email" />
                                                        </div>
                                                        <div className="mb-2">
                                                            <label htmlFor="userpassword" className="form-label">Password</label>
                                                            <div className="position-relative auth-pass-inputgroup mb-3">
                                                                <input onChange={set} name='password' type={passwordicon ? "text" : "password"} className="form-control pe-5 password-input" placeholder="Enter password" />
