...
const ApplicationUserDetails = () => {
    ...
    const  { getallusers, makedisable, makeenable,users,setcurrentpage,currentpage,totalpages }= SuperAdminService()
    ...
    return (
        <div className='modal-open' >
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row pb-4 gy-3">
                            <div className="col-sm-4">
                                <button onClick={() => setToggle(true)} className="btn btn-primary addtax-modal" ><i className="las la-plus me-1" /> Add Shopkeeper</button>
                            </div>
            ...
            {Toggle && <CreateAccountModal getallusers={getallusers} fun={setToggle} />}
        </div>
    )
}
