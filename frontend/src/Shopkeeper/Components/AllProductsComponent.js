...
const AllProductsComponent = () => {
    ...
    const { EditProductToggle, setEditProductToggle, data, editproductid, editobj, editloading, products, currentpage, totalpages, getallproducts, deleteproduct, editproduct, setcurrentpage, seteditloading, seteditobj, seteditproductid } = ProductServices()
    useEffect(() => {
        const getdata = async () => {
                                                                            ...
                                                                            <td>
                                                                                <div className="dropdown">
                                                                                    ...
                                                                                    <ul className="dropdown-menu dropdown-menu-end">
                                                                                        ...
                                                                                        <li ><a onClick={() => deleteproduct(obj._id)} className="dropdown-item remove-item-btn" ><i className="las la-trash-alt fs-18 align-middle me-2 text-muted" />Delete</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>
                                                                        </tr>)
