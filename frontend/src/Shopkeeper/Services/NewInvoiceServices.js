...
const NewInvoiceServices = ({setinvoices}) => {
    ...
    return{ submit,remove,changediscount,removequantity, addquantity, loading,result,items,customer,setitems,setcustomer }
}

export default NewInvoiceServices